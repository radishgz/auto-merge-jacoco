...
public abstract class CoverageLauncher implements ICoverageLauncher,
  ...
  private ILaunchConfigurationDelegate getLaunchDelegate(String launchtype)
    ...
    ConsoleMessage.showMessage("launchtype:" + launchtype + ".."
        + type.getName());
  ...
  public void launch(ILaunchConfiguration configuration, String mode,
    ...
    // ConsoleMessage.showMessage("start launch");
  ...
  public boolean preLaunchCheck(ILaunchConfiguration configuration,
    ...
    if (launchdelegate2 == null) {
      ...
      // ConsoleMessage.showMessage("monitor:" + monitor.getClass().getName());
  ...
  public boolean finalLaunchCheck(ILaunchConfiguration configuration,
    ...
    if (launchdelegate2 == null) {
      ...
      // EclEmmaCorePlugin plugin = EclEmmaCorePlugin.getInstance();
      // File folder = plugin.getExecutionDataFiles().getFolder();
      // CoverageSession session = (CoverageSession) plugin.getSessionManager()
      // .getActiveSession();

      // ConsoleMessage.showMessage("DataSource"
      // + session.getExecutionDataSource().getClass().toString());

      // final File[] files = folder.listFiles();
      // for (IPackageFragmentRoot file : sets) {
      // ConsoleMessage.showMessage("file:" + file.get);
      // }
